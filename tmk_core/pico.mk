...
CFLAGS += -I$(PICO_SDK_PATH)/src/rp2_common/hardware_exception/include
...
SRC += $(PICO_SDK_PATH)/src/rp2_common/hardware_exception/exception.c
...
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/portable/raspberrypi/pio_usb/hcd_pio_usb.c
...
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/host/usbh.c
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/host/hub.c
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/class/cdc/cdc_device.c
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/class/hid/hid_device.c
SRC += $(PICO_SDK_PATH)/lib/tinyusb/src/class/hid/hid_host.c
...
uf2: $(BUILD_DIR)/$(TARGET).bin
	./util/uf2conv.py -c -f 0xe48bff56 -b 0x10000000 -o $(TARGET).uf2 $(BUILD_DIR)/$(TARGET).bin
